...
Text secondSlideTextMain =Text("Take Advantage Of The Offer Shopping",
style: GoogleFonts.rubik(
  fontSize: 30,
  fontWeight: FontWeight.w500
),);
// Text thirdSlideTextMain =Text("All Types Offers Within Your Reach",
// style: GoogleFonts.rubik(
//   fontSize: 30,
//   fontWeight: FontWeight.w500
// ),);
...
Text secondSlideTextsub =Text("Cherish style without compromise. Unbeatable prices meet the latest trends. Elevate your wardrobe with our curated collection. Discover fashion that empowers. Visit us today and experience style that speaks volumes.",
style: GoogleFonts.rubik(
  fontSize: 10,
  fontWeight: FontWeight.w200
),);
